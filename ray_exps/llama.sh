...
python ./core/embedding_finetuning/embedding_LLM_main.py --device cuda:0 --epochs 100 --cfg ./core/yamls/cora/lms/llama.yaml
python ./core/embedding_finetuning/embedding_LLM_tune.py --device cuda:0 --epochs 100 --cfg ./core/yamls/citationv8/lms/llama.yaml --downsampling 0.02
