...
class NCNClassifier(PreTrainedModel):
    def __init__(self, model, cfg, data, dropout=0.0, seed=0,cla_bias=True, feat_shrink=''):
        super().__init__(model.config)
        self.bert_encoder = model
        self.dropout = nn.Dropout(dropout)
        ...
        self.model = GCN(hidden_dim, cfg.decoder.model.hiddim, cfg.decoder.model.hiddim, cfg.decoder.model.mplayers,
                    ...
                    cfg.decoder.model.model, cfg.decoder.model.jk, cfg.decoder.model.gnnedp, xdropout=cfg.decoder.model.xdp, taildropout=cfg.decoder.model.tdp,
                    noinputlin=False)
        ...
        self.optimizer = torch.optim.Adam([{'params': self.model.parameters(), "lr": cfg.decoder.optimizer.gnnlr},
                                      {'params': self.predictor.parameters(), 'lr': cfg.decoder.optimizer.prelr}])
        init_random_state(seed)
    ...
    def forward(self,
        ...
        edge_pos = node_id[pos_mask]
        edge_neg = node_id[neg_mask]
