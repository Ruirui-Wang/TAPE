...
from finetune_embedding_mlp.lm_trainer_tune import  get_model_name, save_to_csv, get_model_name, gcn_dataset, create_GAE_model, compute_metrics
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--cfg', dest='cfg_file', type=str, required=False,
                        default='core/yamls/cora/lms/ft-mpnet.yaml',
...
if __name__ == '__main__':
    ...
    # hyperparameters
    hyperparameter_search = {"hiddendim": [256, 512, 1024], 
                             "predp": [0.1, 0], 
                             "preedp": [0.1, 0]}
    
    # list all parameters relates to NCNC
    ...
    for list_params in tqdm(itertools.product(*hyperparameter_search.values())):
        ...
        for run_id in range(args.repeat):
            ...
            cfg.lm.train.lr = 0.001
            cfg.lm.train.grad_acc_steps = 1 # suggested for small dataset
            cfg.lm.train.batch_size = 32
            cfg.lm.train.epochs = 2
            cfg.lm.train.warmup_epochs = 1

            cfg.lm.model.feat_shrink = 768
            cfg.lm.train.dropout = 0
            cfg.lm.train.att_dropout = 0

            cfg.decoder.model.hiddim = list_params[0]
            cfg.decoder.model.predp = list_params[1]
            cfg.decoder.model.preedp = list_params[2]
            cfg.decoder.model.lnnn = True
            ...
            save_to_csv(tune_params_res, f'tunes/group3_{cfg.dataset}_{cfg.decoder.model.type}_{get_model_name(cfg)}.csv')
