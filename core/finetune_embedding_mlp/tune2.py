...
if __name__ == '__main__':
    ...
    # hyperparameters
    hyperparameter_search = {"feat_shrink": [768, 384, 768*2], 
                             "train_dropout": [0.1, 0.2], 
                             "att_dropout": [0.1, 0.2], 
                             "epochs": [2]}
    ...
    for list_params in tqdm(itertools.product(*hyperparameter_search.values())):
        ...
        for run_id in range(args.repeat):
            ...
            cfg.lm.model.feat_shrink = list_params[0]
            cfg.lm.train.dropout = list_params[1]
            cfg.lm.train.att_dropout = list_params[2]
            cfg.lm.train.epochs = list_params[3]
            ...
            save_to_csv(tune_params_res, f'tunes/group2_{cfg.dataset}_{cfg.decoder.model.type}_{get_model_name(cfg)}.csv')
